...
//                 const timestamp = typeof data.unix_time === 'number' 
//                     ? data.unix_time 
//                     : Date.parse(data.unix_time);
//                 const date = new Date(timestamp);
//                 setUnixTime(date.toISOString());
                
//                 // Buscar tipo parâmetro e casas decimais
...
//                 valor: Number(valor),
//                 unix_time: new Date(unixTime).toISOString(),
//                 estacao: {
//                     id_estacao: parseInt(idEstacao)
//                 },
//                 parametro: {
...
//                 // Se a data for inválida, tenta converter de timestamp
...
//                     Editar Medida {medida?.id_medida}
//                 </div>
